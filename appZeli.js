function limpiarCampo() {
  ...
  if (textoElement) {
    textoElement.value = "";
    munieco.src = "./imgZeli/muñeco.png"; // Restablecer la imagen al principio
...
function encriptar() {
  ...
  if (texto.length != 0){
    ...
    parrafo.textContent = "";
    munieco.src ="./imgZeli/encriptado.png";
  } else {
    munieco.src = "./imgZeli/muñeco.png";
  ...
  if (texto.length != 0){
    ...
    parrafo.textContent = "";
    munieco.src ="./imgZeli/desencriptado.png";
  } else {
    munieco.src = "./imgZeli/muñeco.png";
    tituloMensaje.textContent = "Ningún mensaje fue encontrado";
    parrafo.textContent = "Ingresa el texto que deseas encriptar o desencriptar";
